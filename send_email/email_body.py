	...
	return """
        ...
        <tr>
            <td colspan="2" style="font-size: 15px; background-color: #fff; padding: 20px; line-height: 24px; color:#666">
                ...
                <b>Welcome</b> to the world’s largest traveller community, where millions of people book their best trips.
                <br>
                <br> With millions of reviews, TripAdvisor can help you find the ideal hotel. When you’re ready to book, we check 200+ sites for today’s lowest hotel prices, and once you’re on your trip our free mobile app makes it easy to find great tours, activities and restaurants nearby.
                <br>
                <br> Where will you book your next trip? For a little inspiration, check out the world's #1 Destination
