...
r = requests.request('get', 'https://roofpik-948d0.firebaseio.com/projects/-KYJONgh0P98xoyPPYm9/cghs/.json')
print 'data fetched'
data1 = r.json()
...
#		if(data['live'] == True):
	...
	#for project id
		...
		#print json.dumps(d)
			...
			es.index(index='live_index_cghs', doc_type='data', id=data['projectId'], body=d)
