...
#			return query_builder
			...
			try:
				res = requests.post('https://search-roof-pnslfpvdk2valk5lfzveecww54.ap-south-1.es.amazonaws.com/cghs_index/data/_search?size='+_page_size+'&from='+_page_start, data=query_builder)
#				return 'request made'
...
#				return res
			...
			try:
				r_count = requests.post('https://search-roof-pnslfpvdk2valk5lfzveecww54.ap-south-1.es.amazonaws.com/cghs_index/data/_search')
